...
function newUserInterface() {
  ...
  div.innerHTML = `
    ...
    <button class="input-group-text" onclick="addEmployee()" >Insert User</button>
...
function showEmployeeData() {
  ...
  div.innerHTML = `
    ...
    <br>
    `
  div.appendChild(showUserData(userId));
...
function showUserData(userId) {
  ...
  userTable.className = 'table table-dark table-striped';
  userTable.innerHTML = `
    <thead>
      <tr>
  ...
  apiInteraction('GET', url, null)
    .then((response) => {
      userTable.appendChild(fillUserTable(response));
      console.log('anduvo el show del user');
    })
    .catch((reason) => {
      console.log(Error(reason));
    })
...
function deleteUserData() {
  ...
  apiInteraction('DELETE', 'https://jsonplaceholder.typicode.com/users/${userId}')
    .then((response) => {
      console.log('borro joyaaa');
    })
    .catch((reason) => {
      console.log(Error(reason));
    })
...
function findUser(userId) {
  console.log('Buscando usuario con ID:', userId); // Verifica si userId se pasa correctamente a esta función.

  const url = `https://jsonplaceholder.typicode.com/users/${userId}`;
  console.log('URL para búsqueda:', url); // Verifica la URL generada para búsqueda.


  apiInteraction('GET', 'https://jsonplaceholder.typicode.com/users/${userId}', null)
    .then((response) => {
      console.log(response);
    })
    .catch((reason) => {
